                        ...
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <h4 class="mb-0">{{ Cookie::get('currencyIcon') }}{{ $total_Revenue }}</h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <h4 class="mb-0">{{ Cookie::get('currencyIcon') }} {{ $total_Receivables }}</h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <h4 class="mb-0">{{ Cookie::get('currencyIcon') }}{{ $totalDept }}</h4>
                                </div>
